...
export default function AccountDeletePage() {
  ...
  const handleSubmit = async (transaction: AccountDelete) => {
    setError(null)
  ...
  if (!connected || !address) {
    return (
      <WalletConnectPrompt
        ...
        description="Connect your wallet to delete your account"
        accentColor="purple"
      />
    )
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">
                Delete your XRPL account and transfer remaining XRP
              </p>
            </div>
          </div>
