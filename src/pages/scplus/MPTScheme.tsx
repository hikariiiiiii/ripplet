...
export default function MPTScheme() {
  ...
  const steps = [
    { key: 'define', title: t('scplus.mptScheme.step1') },
    { key: 'kyc', title: t('scplus.mptScheme.step2') },
    { key: 'authorize', title: t('scplus.mptScheme.step3') },
    { key: 'issue', title: t('scplus.mptScheme.step4') },
    { key: 'transfer', title: t('scplus.mptScheme.step5') },
    { key: 'redeem', title: t('scplus.mptScheme.step6') },
  ];
    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-2xl mx-auto space-y-6">
        <div className="flex items-center gap-4">
          ...
          <div className="glass-card border border-purple-500/20 rounded-2xl p-6 flex-1">
