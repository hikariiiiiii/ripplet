...
export default function MPTokenIssuanceDestroyPage() {
  ...
  const handleSubmit = async (transaction: MPTokenIssuanceDestroy) => {
    setError(null);
  ...
  if (!connected || !address) {
    return (
      <WalletConnectPrompt 
        ...
        description="Connect your wallet to destroy MPT issuances"
        accentColor="purple"
      />
    );
  }
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground mt-0.5">
                Permanently destroy an MPT issuance
              </p>
            </div>
          </div>
